(function init() {
    ...
    window.onload = function () {
        ...
        socket.on('newGame', (data) => {
            const message = `Hello, ${data.name}. You can invite your opponent to play this game using this link: ${data.url}`;
        ...
        socket.on('turnPlayed', (data) => {
            ...
            console.log('setCurrentTurn(true)');
            player.setCurrentTurn(true);
        });
